...
import { DeleteUser , showUser } from '../Features/User'; // Corrected import path
   ...
   { users  ? users.map((user) => {  
      ...
      return ( 
        ...
        <div class="p-3 flex items-center justify-between border-b cursor-pointer hover:bg-gray-200">
            ...
            <button class="h-8 px-3 text-md font-bold text-red-400 border border-red-400 rounded-full hover:bg-blue-100" onClick={() => { try {
