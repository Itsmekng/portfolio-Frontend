      ...
      <section className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
        ...
        <div className="flex items-center p-8 bg-white shadow-md rounded-lg">
          ...
          <div>
            ...
            <span className="block text-gray-500">Total Project</span>
          </div>
        </div>
        <div className="flex items-center p-8 bg-white shadow-md rounded-lg">
          ...
          <div>
            ...
            <span className="block text-gray-500">Total Likes in Project</span>
          </div>
        </div>
        <div className="flex items-center p-8 bg-white shadow-md rounded-lg">
          ...
          <div>
            ...
            <span className="block text-gray-500">Contact Us Message</span>
          </div>
        </div>
      </section>
      <section className="grid md:grid-cols-2 xl:grid-cols-4 xl:grid-rows-3 xl:grid-flow-col gap-6">
        <div className="flex flex-col md:col-span-2 md:row-span-2 bg-white shadow rounded-lg">
          <div className="px-6 py-5 font-semibold border border-gray-200">New User (Monthly)</div>
          <div className="p-4 h-12 flex-grow overflow-scroll">
<ApexChart/>
          </div>
        </div>
        ...
        <div className="row-span-3 bg-white shadow rounded-lg">
          <div className="flex items-center justify-between px-6 py-5 font-semibold border border-gray-200">
            <span>All Users</span>
             ...
             users.map((user) => {
              ...
              return (
                ...
                <div className="h-10 w-10 mr-3 bg-gray-100 rounded-full overflow-hidden">
                  <img src={user.avatar.url} alt="Annette Watson profile "/>
                </div>
                <span className="text-gray-600">{user.name} </span>
                
                <span className="ml-auto font-medium border border-solid border-zinc-400 px-3 rounded-2xl ">{user.role}</span>
              </li>
             ...
             users.map((user) => {
              ...
              return (
                <>
                    ...
                    { user.Newletter === true ?   <li className="flex items-center">
                <div className="h-10 w-10 mr-3 bg-gray-100 rounded-full overflow-hidden">
                  <img src={user.avatar.url} alt="Annette Watson profile "/>
                </div>
                <span className="text-gray-600">{user.name} </span>
