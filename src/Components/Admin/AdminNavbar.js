...
<nav className="flex justify-between px-7 py-4 items-center top-0 border border-zinc-200 border-solid ">
  <h6 className="text-xl text-gray-800 font-semibold">Admin Panel</h6>
